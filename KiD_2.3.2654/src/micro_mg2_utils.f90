...
subroutine micro_mg_utils_init( kind, rh2o, cpair, tmelt_in, latvap, &
  ...
  ! pgam dynamically.
  mg_liq_props = NewMGHydrometeorProps(rhow, dsph, min_mean_mass=min_mean_mass_liq)
  mg_ice_props = NewMGHydrometeorProps(rhoi, dsph, lam_bnd_ice, min_mean_mass_ice)
